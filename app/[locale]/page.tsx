...
function page() {
    ...
    return (
        <div className='bg-slate-950 selection:bg-blue-500/30 selection:text-blue-200'>
            {/* Navigation */}
            <AppHeader />
            {/* Hero Section */}
            <section className="relative isolate overflow-hidden pt-32 pb-20 lg:pt-48 lg:pb-32">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center gap-2 py-1 px-4 rounded-full bg-slate-900 border border-slate-800 text-blue-400 text-xs font-bold mb-8 uppercase tracking-widest">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-8">
                        Website Anda Harusnya Jadi <br /><span className="bg-linear-to-r from-blue-200 to-blue-400 bg-clip-text text-transparent">Mesin Penjualan 24/7.</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="https://wa.me/628123456789?text=Halo%20Cylare,%20saya%20mau%20konsultasi%20strategi%20website%20gratis" target="_blank" className="px-8 py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/20 transform hover:-translate-y-1">
                ...
                <div className="mt-16 border-y border-slate-800/50 py-6 bg-slate-900/30 space-x-0 md:space-x-12 flex flex-col md:flex-row justify-center items-center gap-8 text-muted-foreground grayscale opacity-70">
            ...
            <section id="masalah" className="scroll-mt-36 relative isolate overflow-hidden py-24 bg-slate-900/30">
                <div className="absolute top-0 right-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                <div className="absolute top-0 left-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-br-full" />
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Kenapa Bisnis Anda Butuh Website <span className="text-blue-400">Sekarang?</span></h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-slate-900 border border-border hover:border-blue-500/50 transition duration-300 hover:-translate-y-2 p-6 rounded-2xl card-hover relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-32 h-8 blur-3xl bg-blue-500/75 rounded-bl-full" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative bg-slate-900 rounded-2xl p-8 border border-slate-800">
                            <div className="absolute -top-4 -right-2 lg:-right-4 bg-red-800 text-white px-4 py-2 rounded-lg font-bold shadow-lg transform rotate-2">Realita Pahit</div>
            ...
            {/* Solusi */}
            <section id="solusi" className="scroll-mt-32 relative isolate overflow-hidden py-20 bg-slate-900/30 text-white">
                <div className="absolute top-0 right-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                <div className="absolute bottom-0 left-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-tr-full" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="relative overflow-hidden bg-slate-900 p-8 rounded-2xl border border-slate-800">
                        <div className="absolute -top-12 right-0 w-40 h-24 blur-3xl bg-blue-500/50 rounded-bl-full" />
                        ...
                        <div className="pt-4 border-t border-slate-800 text-sm text-blue-300 font-semibold"><span className='text-primary font-normal'>Goal :</span> 1 Tombol Direct WA</div>
                    </div>
                    <div className="relative overflow-hidden bg-slate-900 p-8 rounded-2xl border border-slate-800">
                        <div className="absolute -top-12 right-0 w-40 h-24 blur-3xl bg-blue-500/50 rounded-bl-full" />
                        <div className="text-4xl mb-4">🏢</div>
                        ...
                        <div className="pt-4 border-t border-slate-800 text-sm text-blue-300 font-semibold"><span className='text-primary font-normal'>Goal :</span> Form Penawaran ke WA</div>
                    </div>
                    <div className="relative overflow-hidden bg-slate-900 p-8 rounded-2xl border border-slate-800">
                        <div className="absolute -top-12 right-0 w-40 h-24 blur-3xl bg-blue-500/50 rounded-bl-full" />
                        ...
                        <div className="pt-4 border-t border-slate-800 text-sm text-blue-300 font-semibold"><span className='text-primary font-normal'>Goal :</span> Order Otomatis via WA</div>
                    </div>
                </div>
            </section>

            {/* SECTION 3 & 9: Why Us & Guarantees */}
            <section id="solusi" className="py-24 bg-slate-950">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold leading-relaxed text-white mb-8">Kenapa Cylare Beda dari Tukang Web <span className="text-blue-300">500 Ribuan?</span></h2>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    <div className="shrink-0 h-10 w-10 flex items-center justify-center rounded-lg bg-slate-900 text-blue-400 text-xl font-bold">✓</div>
                                    <div>
                        ...
                        <div className="relative">
                            ...
                            <div className="bg-slate-900 border border-slate-800 p-8 rounded-3xl relative">
                                <div className="text-center mb-6">
                                    <span className="inline-block bg-blue-500/10 text-blue-400 px-4 py-1 rounded-full text-xs font-bold uppercase tracking-widest border border-blue-500/20">Komitmen Kami</span>
                                </div>
            ...
            <section className="relative isolate overflow-hidden py-16 bg-slate-900/30">
                <div className="absolute top-0 right-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                <div className="absolute -top-1/2 right-[calc(50%-20rem)] w-64 h-64 blur-3xl bg-blue-500/10 rounded-b-full" />
                <div className="absolute bottom-0 left-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-tr-full" />
                <div className="absolute -bottom-1/2 left-[calc(50%-26rem)] w-72 h-72 blur-3xl bg-blue-500/10 rounded-t-full" />
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold leading-tight text-white mb-6">Siap Punya Website yang<br />Bekerja Otomatis?</h2>
                    <p className="text-blue-100 mb-8 opacity-90">Berhenti buang waktu melayani <br className='sm:hidden' /> prospek yang tidak serius.<br />Biarkan website memfilter <br className='sm:hidden' /> mereka untuk Anda.</p>
            ...
            <section id="simulasi" className="scroll-mt-28 py-24 bg-slate-950">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Simulasi Proyek <br className='sm:hidden' /> <span className="text-blue-400">(Studi Kasus)</span></h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-slate-900/50 p-8 rounded-3xl border border-slate-800 relative group overflow-hidden">
                            <div className="absolute -top-12 right-0 w-40 h-24 blur-3xl bg-blue-500/50 rounded-bl-full" />
                            <div className="inline-block px-3 py-1 bg-blue-500/20 text-blue-400 rounded-lg text-xs font-bold mb-4">Bisnis F&amp;B / Coffee Shop</div>
                            ...
                            <div>
                                <p className="text-xs text-blue-400 uppercase font-bold mb-1">Solusi Cylare:</p>
                        ...
                        <div className="bg-slate-900/50 p-8 rounded-3xl border border-slate-800 relative group overflow-hidden">
                            <div className="absolute -top-12 right-0 w-40 h-24 blur-3xl bg-blue-500/50 rounded-bl-full" />
                            <div className="inline-block px-3 py-1 bg-blue-500/20 text-blue-400 rounded-lg text-xs font-bold mb-4">Skincare / Fashion Lokal</div>
                        ...
                        <div className="bg-slate-900/50 p-8 rounded-3xl border border-slate-800 relative group overflow-hidden">
                            <div className="absolute -top-12 right-0 w-40 h-24 blur-3xl bg-blue-500/50 rounded-bl-full" />
                            <div className="inline-block px-3 py-1 bg-blue-500/20 text-blue-400 rounded-lg text-xs font-bold mb-4">Jasa / B2B Consultant</div>
            ...
            <section id="proses" className="scroll-mt-24 relative isolate overflow-hidden py-24 bg-slate-900/30">
                <div className="absolute top-0 right-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                <div className="absolute top-[calc(50%-0rem)] right-[calc(50%-30rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-b-full" />
                <div className="absolute bottom-0 left-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-tr-full" />
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Cara Kerja Kami <br  className='sm:hidden'/> <span className="text-blue-400">(Anti Ribet)</span></h2>
                    ...
                    <div className="relative max-w-3xl mx-auto">
                        <div className="absolute left-4.5 sm:left-8 top-0 bottom-0 w-0.5 bg-slate-800 block" />
                        <div className="space-y-12">
                            <div className="relative flex items-start gap-6 md:gap-10">
                                <div className="w-10 h-10 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-slate-900 border border-slate-700 text-blue-400 flex items-center justify-center font-bold text-xl sm:text-2xl shrink-0 z-10 relative">1</div>
                                <div className="pt-3">
                            ...
                            <div className="relative flex items-start gap-6 md:gap-10">
                                <div className="w-10 h-10 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-slate-900 border border-slate-700 text-blue-400 flex items-center justify-center font-bold text-xl sm:text-2xl shrink-0 z-10 relative">2</div>
                                <div className="pt-3">
                            ...
                            <div className="relative flex items-start gap-6 md:gap-10">
                                <div className="w-10 h-10 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-slate-900 border border-slate-700 text-blue-400 flex items-center justify-center font-bold text-xl sm:text-2xl shrink-0 z-10 relative">3</div>
                                <div className="pt-3">
                            ...
                            <div className="relative flex items-start gap-6 md:gap-10">
                                <div className="w-10 h-10 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-slate-900 border border-slate-700 text-blue-400 flex items-center justify-center font-bold text-xl sm:text-2xl shrink-0 z-10 relative">4</div>
                                <div className="pt-3">
                            ...
                            <div className="relative flex items-start gap-6 md:gap-10">
                                <div className="w-10 h-10 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-blue-500 text-white flex items-center justify-center font-bold text-2xl shrink-0 z text-xl-sm:10 shadow-lg shadow-blue-500/30">🚀</div>
                                <div className="pt-3">
            ...
            <section id="harga" className="py-24 bg-slate-950">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-slate-400">Harga di bawah ini adalah harga <br className='sm:hidden' /> sekali bayar pembuatan. <br />Bisa <span className="text-white font-bold">Bayar DP 40%</span> dulu <br className='sm:hidden' /> untuk mulai pengerjaan.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* Plan 1 */}
                        <div className="relative isolate overflow-hidden bg-slate-900/30 border border-slate-800 p-8 rounded-3xl flex flex-col hover:border-blue-500/30 transition">
                            <div className="absolute top-0 right-0 w-32 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                            <h3 className="text-xl font-bold text-white mb-2">Basic <span className='text-base font-semibold text-blue-300 align-middle ms-1'>Landing Page</span></h3>
                            <p className="text-sm text-slate-500 mb-6">Cocok untuk jualan 1 produk, validasi ide bisnis, atau halaman khusus untuk iklan FB/TikTok Ads.</p>
                            <div className="text-md font-medium text-slate-300">Mulai dari:</div>
                            <div className="text-md font-medium line-through text-slate-400 mb-0">Rp 1.500.000</div>
                            <div className="text-3xl font-extrabold text-white mb-8">Rp 800.000</div>
                            <ul className="space-y-4 mb-10 text-sm text-slate-400 grow">
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> 1 Halaman</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Tombol WhatsApp</li>
                                <li className="flex items-center gap-2 font-bold text-blue-300"><CheckIcon size={18} className='text-blue-400' /> Maksimal 3x Revisi</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Simple SEO Setup</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Responsif Desain Terjamin</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Copywriting</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Tautan IG, FB, TikTok, Dll</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Gratis Domain .com 1 tahun</li>
                            </ul>
                            <a href="https://wa.me/628123456789?text=Saya%20tertarik%20Paket%20Starter" className="w-full py-4 text-center bg-slate-800 text-white rounded-xl font-bold hover:bg-slate-700 transition">Konsultasi Sekarang</a>
                        </div>
                        {/* Plan 2: Best Value */}
                        <div className="bg-slate-900 border-2 border-blue-500 p-8 rounded-3xl flex flex-col relative transform lg:-translate-y-6 shadow-2xl shadow-blue-500/10">
                            <div className="absolute top-0 right-0 w-32 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-blue-500 text-white px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">Paling Sering Dipilih</div>
                            <h3 className="text-xl font-bold text-white mb-2">Plus <span className='text-base font-semibold text-blue-300 align-middle ms-1'>Company Profile</span></h3>
                            <p className="text-sm text-slate-400 mb-6">Tampil lebih profesional dan meyakinkan. Cocok untuk profil perusahaan, web instansi, atau portofolio bisnis jasa.</p>
                            <div className="text-md font-medium text-slate-300">Mulai dari:</div>
                            <div className="text-md font-medium line-through text-slate-400 mb-0">Rp 2.700.000</div>
                            <div className="text-3xl font-extrabold text-white mb-8">Rp 1.300.000</div>
                            <ul className="space-y-4 mb-10 text-sm text-slate-300 grow">
                                ...
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Sampai 5-6 Halaman</li>
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Copywriting</li> */}
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Desain Plus + Dark Mode</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Tombol/Form Order WhatsApp</li>
                                <li className="flex items-center gap-2 font-bold text-blue-300"><CheckIcon size={18} className='text-blue-400' /> Maksimal 5x Revisi</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Basic SEO Setup (Google)</li>
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Gratis Domain .com 1 tahun</li> */}
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Responsif Desain Terjamin</li> */}
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Lokasi Peta (Google Maps)</li>
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Tautan IG, FB, TikTok, Dll</li> */}
                            </ul>
                        ...
                        <div className="relative isolate overflow-hidden bg-slate-900/30 border border-slate-800 p-8 rounded-3xl flex flex-col hover:border-blue-500/30 transition">
                            <div className="absolute top-0 right-0 w-32 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                            <h3 className="text-xl font-bold text-white mb-2">Pro <span className='text-base font-semibold text-blue-300 align-middle ms-1'>E Commerce</span></h3>
                            <p className="text-sm text-slate-500 mb-6">Punya toko online sendiri atau coffee shop. Lengkap dengan fitur keranjang belanja</p>
                            <div className="text-md font-medium text-slate-300">Mulai dari:</div>
                            <div className="text-md font-medium line-through text-slate-400 mb-0">Rp 4.600.000</div>
                            <div className="text-3xl font-extrabold text-white mb-8">Rp 2.900.000</div>
                            <ul className="space-y-4 mb-10 text-sm text-slate-400 grow">
                                <li className="text-md font-medium text-primary">Semua yang ada di Plus, Pro:</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Sampai 10-12 Halaman</li>
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Copywriting</li> */}
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Desain Pro + Dark Mode</li> */}
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Sistem Keranjang Belanja</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Tombol & Order List ke Whatsapp</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Halaman Admin Manajemen Produk</li>
                                <li className="flex items-center gap-2 font-bold text-blue-300"><CheckIcon size={18} className='text-blue-400' /> Maksimal 8x Revisi</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Advanced SEO Setup (Google)</li>
                                <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Tutorial Penggunaan Admin Panel</li>
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Gratis Domain .com 1 tahun</li> */}
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Responsif Desain Terjamin</li> */}
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Lokasi Peta (Google Maps)</li> */}
                                {/* <li className="flex items-center gap-2"><CheckIcon size={18} className='text-blue-400' /> Tautan IG, FB, TikTok, Dll</li> */}
                            </ul>
                            <a href="https://wa.me/628123456789?text=Saya%20tertarik%20Paket%20Katalog" className="w-full py-4 text-center bg-slate-800 text-white rounded-xl font-bold hover:bg-slate-700 transition">Konsultasi Sekarang</a>
                        </div>
                    </div>
                    <div className="mt-12 max-w-2xl mx-auto bg-slate-900/30 p-8 rounded-3xl border border-slate-800 shadow-xl">
                        ...
                        <div className="flex justify-between items-center py-3 border-b border-slate-700 text-sm sm:text-base">
                            <span className="text-slate-400">Blog / Artikel + Admin Panel</span>
                            <span className="font-medium text-primary">+ Rp 1.000.000</span>
                        </div>
                        <div className="flex justify-between items-center py-3">
                            <span className="text-slate-400">Multi-bahasa (ID/EN)</span>
                            <span className="font-medium text-primary">+ Rp 500.000</span>
                        </div>
                    </div>
            ...
            <section className='relative isolate overflow-hidden bg-slate-900/30 py-16'>
                <div className="absolute top-0 right-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                <div className="absolute -top-1/2 right-[calc(50%-20rem)] w-64 h-64 blur-3xl bg-blue-500/10 rounded-b-full" />
                <div className="absolute bottom-0 left-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-tr-full" />
                <div className="absolute -bottom-1/2 left-[calc(50%-26rem)] w-72 h-72 blur-3xl bg-blue-500/10 rounded-t-full" />
            ...
            <section className="py-24">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="relative isolate overflow-hidden p-8 md:p-12 rounded-[40px] bg-slate-900/30 border border-slate-800/50">
                        <div className="absolute top-0 right-0 w-64 h-64 blur-3xl bg-blue-500/10 rounded-bl-full" />
                        <div className="absolute top-0 left-0 w-40 h-40 blur-3xl bg-blue-500/10 rounded-b-full" />
                        <div className="absolute bottom-0 left-0 w-80 h-80 blur-3xl bg-blue-500/10 rounded-tr-full" />
                        <div className="w-24 h-24 bg-linear-to-br from-slate-700 to-slate-900 border-2 border-blue-500 rounded-full mx-auto mb-6 flex items-center justify-center text-4xl overflow-hidden">
                            🧑‍💻
                        </div>
            ...
            {/* Final CTA */}
            <section className="py-24 relative isolate overflow-hidden bg-slate-900/30">
                <div className="absolute top-0 right-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-bl-full" />
                <div className="absolute -top-12 right-[calc(50%-20rem)] w-64 h-64 blur-3xl bg-blue-500/10 rounded-b-full" />
                <div className="absolute bottom-0 left-[calc(50%-50rem)] w-80 h-80 blur-3xl bg-blue-500/10 rounded-tr-full" />
                <div className="absolute -bottom-12 left-[calc(50%-26rem)] w-72 h-72 blur-3xl bg-blue-500/10 rounded-t-full" />
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">Masih Ragu? <span className="text-blue-400">Kita Ngobrol Dulu Aja.</span></h2>
                    ...
                    <div className="bg-slate-950 border border-blue-500 p-10 rounded-[40px] shadow-2xl relative">
                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-blue-500 px-4 py-1 rounded-full text-white font-bold text-xs uppercase shadow-lg shadow-blue-500/30">Admin Standby</div>
